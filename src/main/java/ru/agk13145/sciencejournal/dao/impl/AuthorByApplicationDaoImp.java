...
public class AuthorByApplicationDaoImp implements AuthorByApplicationDao {
    ...
    private final static String SQL_SELECT_AUTHORBYAPPLICATION = "SELECT ID, APPLICATION_ID, AUTHORs_BY_AFFILIATION_ID FROM sciencejournal.authorbyapplication " +
            "WHERE id = :id";

    private final static String SQL_CREATE_AUTHORBYAPPLICATION = "INSERT INTO " +
            "sciencejournal.authorbyapplication(application_id, authors_by_affiliation_id) VALUES (:application_id, :author_by_affiliation_id)";

    private final static String SQL_UPDATE_AUTHORBYAPPLICATION = "UPDATE sciencejournal.authorbyapplication " +
            "SET application_id = :application_id, authors_by_affiliation_id=:authors_by_affiliation_id WHERE id = :id";

    private final static String SQL_DELETE_AUTHORBYAPPLICATION = "DELETE FROM sciencejournal.authorbyapplication WHERE id = :id";

    private final static String SQL_SELECT_ALL_AUTHORBYAPPLICATION = "SELECT ID, APPLICATION_ID, AUTHORS_BY_AFFILIATION_ID  FROM sciencejournal.authorbyapplication ORDER BY id ASC";

    private final static String SQL_SELECT_AUTHORBYAPPLICATION_BY_APPLICATION_ID = "SELECT ID, APPLICATION_ID, AUTHORS_BY_AFFILIATION_ID FROM sciencejournal.authorbyapplication " +
    ...
    @Override
    public List<AuthorByApplication> findByApplicationId(Integer applicationId) {
        Map<String, Object> params = new HashMap<>();
        params.put("application_id", applicationId);
        return namedParameterJdbcTemplate.query(SQL_SELECT_AUTHORBYAPPLICATION_BY_APPLICATION_ID, params, new AuthorByApplicationMapper());
    }
    ...
    public Integer createAuthorByApplication(AuthorByApplication authorByApplication) {
        ...
        namedParameters.addValue("authors_by_affiliation_id", authorByApplication.getAuthorByAffiliationId());
    ...
    public void updateAuthorByApplication(AuthorByApplication authorByApplication) {
        ...
        params.put("authors_by_affiliation_id", authorByApplication.getAuthorByAffiliationId());
